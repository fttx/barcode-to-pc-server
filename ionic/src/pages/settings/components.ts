...
export const functions: OutputBlockModel[] = [
  ...
  { name: 'GOOGLE_SHEETS',       icon: 'table',           value: '',                  type: 'google_sheets', skipOutput: true,  label: null, googleSheetsUrl: '', googleSheetsAction: 'append_or_update', googleSheetsValues: [], httpUseResultAsACK: true },
