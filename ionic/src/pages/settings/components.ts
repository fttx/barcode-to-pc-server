...
export const functions: OutputBlockModel[] = [
  ...
  { name: 'GOOGLE_SHEETS',       icon: 'table',           value: '',                  type: 'google_sheets', allowOOBExecution: true,  skipOutput: false, label: null, googleSheetsUrl: '', googleSheetsAction: 'append', googleSheetsValues: [] },
